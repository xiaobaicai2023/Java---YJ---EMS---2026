 ...
 */
public class FeignVariableConfigPresetsUtils {
    // 预设（普通图表）
    public static FeignVariableConfigVo config(String configSign, Integer storageType) {

        FeignVariableConfigVo presetsVo = new FeignVariableConfigVo();
