package com.yunpower.system.api.domain.vo;
 ...
 * @description:
 */
public class FeignVariableConfigVo implements Serializable {
    /**
     * 变量名称
     */
     ...
     * 子列表
     */
    List<FeignVariableConfigVo> children;
    ...
    public List<FeignVariableConfigVo> getChildren() {
        return children;
    }

    public void setChildren(List<FeignVariableConfigVo> children) {
