 ...
 * @author yunpower
 */
public interface ISysCommonDictService {
    /**
     * 根据条件分页查询字典类型
     *
     ...
     * @return 结果
     */
    public int insertDictType(SysCommonDict dictType);
     ...
     * @return 结果
     */
    public int updateDictType(SysCommonDict dictType);
     ...
     * @return 结果
     */
    public boolean checkDictTypeUnique(SysCommonDict dictType);
