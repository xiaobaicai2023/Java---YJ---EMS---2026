...
import com.yunpower.system.domain.SysRoleDept;
import com.yunpower.system.domain.SysRoleMenu;
import com.yunpower.system.domain.SysUserRole;
import com.yunpower.system.mapper.SysRoleDeptMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public int insertRole(SysRole role) {
        if (role.getEntId() == null || role.getEntId() <= 0) {
            role.setEntId(publicService.getCurrentEnterprise());
        }
        if (role.getDeptId() == null || role.getDeptId() <= 0) {
            role.setDeptId(publicService.getCurrentStation());
        }
        if (role.getStopFlag() == null) {
            role.setStopFlag(0);
        }

        role.setCreateBy(SecurityUtils.getNickName());
    ...
    public int updateRole(SysRole role) {
        role.setUpdateBy(SecurityUtils.getNickName());
