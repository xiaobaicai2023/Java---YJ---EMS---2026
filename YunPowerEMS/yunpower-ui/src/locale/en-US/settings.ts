export default {
  ...
  'settings.navbar.toMotif': 'Click to switch theme',
  'settings.navbar.theme.title': 'Install Theme',
  'settings.navbar.theme.resetTheme': 'Reset Theme',
  'settings.navbar.theme.install': 'Install',
  'settings.navbar.theme.currentThemes': 'Current',
