export default {
  ...
  'settings.navbar.toMotif': '点击切换主题',
  'settings.navbar.theme.title': '安装主题',
  'settings.navbar.theme.resetTheme': '重置主题',
  'settings.navbar.theme.install': '安装',
  'settings.navbar.theme.currentThemes': '当前主题',
